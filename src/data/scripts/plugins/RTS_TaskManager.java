...
public class RTS_TaskManager extends RTS_StatefulClasses {
    ...
    public RTS_TaskManager (Object state) {
        ...
        HashMap<String, Object> init = new HashMap<String, Object>() {{
            ...
            put("assignmentQueue", new HashMap<>());
            put("translateStore", new HashMap<>());
            put("rotationStore", new HashMap<>());
            put("togaStore", new HashMap<>());
    ...
    public void buildListeners ()  {
        RTS_Listener deadShipListener = new RTS_Listener() {
            ...
            public void run(HashMap<String, Object> e) {
                if (getState("assignments") != null)
                    deleteAssignments((List<ShipAPI>)e.get("shipsNoLongerActive"), true);
                e.clear();
            }
    ...
    public void createAssignments (
        ...
        if (queueInfo == null) {
            if (attackMove)
                ...
                checkList.put("moveAndRelease", moveAndRelease
                        && !(boolean)this.getDeepState(Arrays.asList("config", "switchRightClick")));
        ...
        for (ShipAPI x: selection) {
            if (clearQueue && (((HashMap<String, List<HashMap<String, Object>>>)this.getState("assignmentQueue"))
                    .get(x.getId()) != null
                    && !((HashMap<String, List<HashMap<String, Object>>>)this.getState("assignmentQueue"))
                    .get(x.getId()).isEmpty())) {
                for (HashMap<String, Object> queue :
                        ((HashMap<String, List<HashMap<String, Object>>>)this.getState("assignmentQueue")).get(x.getId()))
                    queue.clear();
                ((HashMap<String, List<HashMap<String, Object>>>)this.getState("assignmentQueue")).get(x.getId()).clear();
            }
    ...
    public void queueAssignments (List<ShipAPI> selection, Vector2f coOrd, Vector2f coOrdSec, boolean moveAndRelease, boolean attackMove) {
        ...
        for (ShipAPI ship : selection) {
            ...
            assignmentPointer = (HashMap<String, Object>)((HashMap<String, Object>)this.getState("assignments")).get(ship.getId());
    ...
    public ShipAPI getEnemies (String type, Vector2f coOrd, Vector2f coOrdSec) {
        if (type.equals("primary")) {
            List<ShipAPI> targetedEnemyHoldPrimary = (boolean)this.getState("combatStarted")
                    ? ((RTS_ShipLocAPI)this.getState("ShipLocAPI")).findEnemyShipNeighbours(coOrd, 500f, true)
                    : new ArrayList<>();
            ShipAPI primaryEnemy = null;
            ...
            List<ShipAPI> targetedEnemyHoldSecondary = (boolean)this.getState("combatStarted") && coOrdSec != null
                    ? ((RTS_ShipLocAPI)this.getState("ShipLocAPI")).findEnemyShipNeighbours(coOrdSec, 500f, true)
                    : new ArrayList<>();
            ShipAPI secondaryEnemy = null;
    ...
    public void drawAndAssignAssignmentFromQueue (String ship) {
        ...
        if (
            ...
            queuePointer = ((HashMap<String, List<HashMap<String, Object>>>)this
                    .getState("assignmentQueue")).get(ship);
            this.drawAssignmentQueue(queuePointer);
        }
        else
            return;
        if (((HashMap<String, Object>)this.getState("assignments")).get(ship) != null)
            return;
    ...
    public void popAssignmentQueue (List<ShipAPI> selection) {
       ...
       List<HashMap<String, Object>> queuePointer;
        for (ShipAPI x: selection) {
            queuePointer = ((HashMap<String, List<HashMap<String, Object>>>)this.getState("assignmentQueue"))
                    .get(x.getId());
    ...
    public void deleteAssignments (List<ShipAPI> selection, boolean clearQueue) {
        ...
        for (ShipAPI x: selection) {
            ...
            if (clearQueue && (((HashMap<String, List<HashMap<String, Object>>>)this.getState("assignmentQueue"))
                    ...
                    && !((HashMap<String, List<HashMap<String, Object>>>)this.getState("assignmentQueue"))
                    .get(x.getId()).isEmpty())) {
                for (HashMap<String, Object> queue : ((HashMap<String, List<HashMap<String, Object>>>)this.getState("assignmentQueue")).get(x.getId()))
                    queue.clear();
                ((HashMap<String, List<HashMap<String, Object>>>)this.getState("assignmentQueue")).get(x.getId()).clear();
            }
        }
    ...
    public void translateAssignments (List<ShipAPI> selection, Vector2f grabPoint, Vector2f placePoint, boolean mockUp, boolean queue) {
        ...
        for (ShipAPI ship : selection) {
            assPointer = (HashMap<String, Object>)this.getDeepState(Arrays.asList("assignments", ship.getId()));
            if (assPointer == null || assPointer.get("targetEnemy") != null)
                continue;
            ((HashMap<String, Vector2f>)this.getState("translateStore")).put(ship.getId(), new Vector2f(
                    translate.getX(),
                    translate.getY()
            ));
        }
    ...
    public void rotateAssignments (List<ShipAPI> selection, Vector2f grabPoint, Vector2f placePoint, boolean mockUp, boolean queue) {
        ...
        HashMap<String, Float> rotationStore = (HashMap<String, Float>)this.getState("rotationStore");
        HashMap<String, Object> assPointer;
...
//                  keep this and integrate it as a pro feature   rotationStore.get(ship.getId()) == null ? angle : rotationStore.get(ship.getId()) + angle //
    ...
    public void setAssignmentsMockUps (boolean queue) {
        if (((HashMap<String, Vector2f>)this.getState("translateStore")).isEmpty()
                && ((HashMap<String, Vector2f>)this.getState("rotationStore")).isEmpty())
            return;
        HashMap<String, Vector2f> translateStore = (HashMap<String, Vector2f>)this.getState("translateStore");
        HashMap<String, Float> rotationStore = (HashMap<String, Float>)this.getState("rotationStore");
        HashMap<String, Object> assPointer;
        ...
        if (!translateStore.isEmpty())
            for (Map.Entry<String, Vector2f> shipStore : translateStore.entrySet()) {
                assPointer = (HashMap<String, Object>)((HashMap<String, Object>)this.getState("assignments"))
    ...
    public boolean convertAssignmentOrQueueToAttackMove(ShipAPI ship, boolean isShiftDown) {
        HashMap<String, Object> assPointer =
                (HashMap<String, Object>)((HashMap<String, Object>)this.getState("assignments")).get(ship.getId());
        if (assPointer == null)
            return (false);
        HashMap<String, List<HashMap<String, Object>>> assignmentQueue =
                (HashMap<String, List<HashMap<String, Object>>>)this.getState("assignmentQueue");
    ...
    public void addNewTogaInstance (List<ShipAPI> selection) {
        ...
        for (ShipAPI ship : selection)
            if (((HashMap<String, Object>)this.getState("assignments")).get(ship.getId()) != null)
        ...
        for (ShipAPI ship : viableShips) {
            if (((HashMap<String, RTS_MoveTogetherManager>)this.getState("togaStore")).get(ship.getId()) != null) {
                if (instancePointer == null) {
                    instancePointer = ((HashMap<String, RTS_MoveTogetherManager>)this.getState("togaStore")).get(ship.getId());
                    deleteInstance = true;
                }
                if (instancePointer != ((HashMap<String, RTS_MoveTogetherManager>)this.getState("togaStore")).get(ship.getId())) {
        ...
        if (newInstanceDeleteOld) {
            RTS_MoveTogetherManager instanceHold = new RTS_MoveTogetherManager(viableShips, (HashMap<String, Object>)this.getState("assignments"));
            for (ShipAPI ship : viableShips) {
                instancePointer = ((HashMap<String, RTS_MoveTogetherManager>)this.getState("togaStore")).get(ship.getId());
                if (instancePointer != null)
                ...
                ((HashMap<String, RTS_MoveTogetherManager>)this.getState("togaStore")).put(ship.getId(), instanceHold);
            }
            instanceFlag = 3;
        }
            ...
            for (ShipAPI ship : viableShips) {
                instancePointer = ((HashMap<String, RTS_MoveTogetherManager>)this.getState("togaStore")).get(ship.getId());
                if (instancePointer != null) {
                    instanceHold = ((HashMap<String, RTS_MoveTogetherManager>)this.getState("togaStore")).get(ship.getId());
                    break;
                }
            }
            ...
            if (instancePointer.queueForDeletion())
                instancePointer.cleanup();
            for (ShipAPI ship : viableShips)
                ((HashMap<String, RTS_MoveTogetherManager>)this.getState("togaStore")).put(ship.getId(), null);
            instanceFlag = 4;
        }
        else {
            RTS_MoveTogetherManager instanceHold = new RTS_MoveTogetherManager(viableShips, (HashMap<String, Object>)this.getState("assignments"));
    ...
    public void drawAssignmentQueue (List<HashMap<String, Object>> queuePointer) {
        ...
        for (HashMap<String, Object> qInst : queuePointer){
            assignment = (HashMap<String, Object>)((HashMap<String, Object>)this.getState("assignments")).get(((ShipAPI)qInst.get("ship")).getId());
            if (assignment == null
                    || !((boolean)this.getState("isAltDown")
                    || (this.getState("currentSelection") != null
                    && ((List<ShipAPI>)this.getState("currentSelection")).contains(((List<ShipAPI>)qInst.get("selection")).get(0)))
            ))
                return;
    ...
    private void hookFriendlyAIs () {
        ((RTS_EventManager)this.getState("eventManager")).addListener(new RTS_Listener() {
            @Override
            public String type() { return("newShipsDeployed"); };

            @Override
            public void run(HashMap<String, Object> e) {
                List<ShipAPI> newShips = (List<ShipAPI>)e.get("newShipsDeployed");
                for (ShipAPI ship : newShips) {
                    if (((RTS_SelectionListener)getState("selectionListener")).dontSelect(ship))
                        continue;
                    ((RTS_AIInjector)getState("AIInjector")).hookAI(ship);
                }
                e.clear();
            }
    ...
    private void firstFrameInit () {
        if (!(boolean)this.getState("firstFrameInit")) {
            ...
            ((RTS_SelectionListener)this.getState("selectionListener")).buildListeners();
            this.buildListeners();
        }
    }
    ...
    public void update (float elapsedTime) {
        ...
        if ((boolean)this.getState("combatStarted")) {
            ...
            ((RTS_AIInjector)this.getState("AIInjector")).update();

            List<RTS_MoveTogetherManager> hold = new ArrayList<>();
            List<String> sHold = new ArrayList<>();

            for(Map.Entry<String, RTS_MoveTogetherManager> instance : ((HashMap<String, RTS_MoveTogetherManager>)this.getState("togaStore")).entrySet()) {
            ...
            for (String id : sHold)
                ((HashMap<String, RTS_MoveTogetherManager>)this.getState("togaStore")).put(id, null);
        ...
        for (HashMap.Entry<String, List<HashMap<String, Object>>> x
                : ((HashMap<String, List<HashMap<String, Object>>>)this.getState("assignmentQueue")).entrySet())
