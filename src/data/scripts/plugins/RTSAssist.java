    ...
    private void getConfig () {
        ...
        HashMap<String, Object> initConfig = new HashMap<String, Object>() {{
            if (!Global.getSettings().getModManager().isModEnabled("lunalib")) {
                ...
                put(RTSAssist.coNames.maxZoom, LunaSettings.getDouble("RTSAssist", "RTSA_SettingsConfig_maxZoom").floatValue()); //3f
            ...
            put(RTSAssist.coNames.switchRightClick, false);
            ...
            if (!Global.getSettings().getModManager().isModEnabled("lunalib")) {
                ...
                put(RTSAssist.hoNames.enable_RTSMode, LunaSettings.getInt(
                        ...
                        "RTSA_SettingsKeybind_enable_RTSMode").equals(Keyboard.KEY_CAPITAL)
                                ? null
                                : Keyboard.getKeyName(LunaSettings.getInt("RTSAssist", "RTSA_SettingsKeybind_enable_RTSMode")).charAt(0)
                );
                put(RTSAssist.hoNames.saveLayout, Keyboard.getKeyName(LunaSettings.getInt("RTSAssist", "RTSA_SettingsKeybind_saveLayout")).charAt(0));
                put(RTSAssist.hoNames.loadLayout, Keyboard.getKeyName(LunaSettings.getInt("RTSAssist", "RTSA_SettingsKeybind_loadLayout")).charAt(0));
                put(RTSAssist.hoNames.deleteAssignments, Keyboard.getKeyName(LunaSettings.getInt("RTSAssist", "RTSA_SettingsKeybind_deleteAssignments")).charAt(0));
                put(RTSAssist.hoNames.vent, Keyboard.getKeyName(LunaSettings.getInt("RTSAssist", "RTSA_SettingsKeybind_vent")).charAt(0));
                put(RTSAssist.hoNames.useSystem, Keyboard.getKeyName(LunaSettings.getInt("RTSAssist", "RTSA_SettingsKeybind_useSystem")).charAt(0));
                put(RTSAssist.hoNames.moveTogether, Keyboard.getKeyName(LunaSettings.getInt("RTSAssist", "RTSA_SettingsKeybind_moveTogether")).charAt(0));
                put(RTSAssist.hoNames.attackMove, Keyboard.getKeyName(LunaSettings.getInt("RTSAssist", "RTSA_SettingsKeybind_attackMove")).charAt(0));
            }
