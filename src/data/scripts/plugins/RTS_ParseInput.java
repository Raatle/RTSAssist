            ...
            if (x.isMouseMoveEvent()) {
                ...
                if (x.isKeyboardEvent()) {
                    if ((boolean)this.getState("inDevelopment")
                        ...
                        x.consume();
                    } else if (x.getEventChar() == (char)hotKeys.get("moveTogether")
                            || x.getEventChar() == (char)((char) hotKeys.get("moveTogether") + 32)
                    ) {
                        ((RTS_TaskManager)this.getState("taskManager")).addNewTogaInstance(
                                (List<ShipAPI>)this.getState("currentSelection")
                        );
                        x.consume();
                    } else if (x.getEventChar() == (char)hotKeys.get("attackMove")
                            || x.getEventChar() == (char)((char) hotKeys.get("attackMove") + 32)
                    ) {
                        if (this.getState("currentSelection") != null)
                            for(ShipAPI ship: (List<ShipAPI>)this.getState("currentSelection")) {
                                if (!((RTS_TaskManager)this.getState("taskManager"))
                                        .convertAssignmentOrQueueToAttackMove(
                                                ship,
                                                (boolean)this.getState("isShiftDown")
                                        )
                                ) {
                                    if (!(boolean)this.getState("isShiftDown"))
                                        ...
                                        ((RTS_TaskManager)this.getState("taskManager")).queueAssignments(
                                                Arrays.asList(ship),
                                                (Vector2f)this.getState("worldSpace"),
                                                null,
                                                true,
                        ...
                        if (!(boolean)this.getState("isShiftDown"))
                            ...
                            ((RTS_TaskManager)this.getState("taskManager")).popAssignmentQueue(
                                    (List<ShipAPI>)this.getState("currentSelection")
                            );
                        x.consume();
                        ...
                        if ((boolean)this.getState("isAltDown")) {
                            if (this.getState("leftClickStoreSec") == null) {
                                this.setState("leftClickStoreSec", this.getState("worldSpace"));
                ...
                if (!(boolean)this.getState("isAltDown")) {
                    this.setState("leftClickStore", null);
                    this.setState("leftClickStoreSec", null);
                    if (this.getState("translateStore") != null) {
                        ((HashMap<?, ?>)this.getState("translateStore")).clear(); // Taskmanager State
                        ((HashMap<?, ?>)this.getState("rotationStore")).clear(); // Taskmanager State
                    }
                }
                if (!(boolean)this.getState("isCtrlDown"))
                    this.setState("leftClickStoreSec", null);
                    ...
                    if (x.isLMBDownEvent()) {
                        ...
                        if ((boolean)this.getState("isAltDown") && !(boolean)this.getState("isCtrlDown"))
                            ...
                            ((RTS_TaskManager)this.getState("taskManager")).rotateAssignments(
                                    (List <ShipAPI>)this.getState("currentSelection"),
                                    (Vector2f)this.getState("leftClickStoreSec"),
                                    (Vector2f)this.getState("worldSpace"),
                                    false,
                                    (boolean)this.getState("isShiftDown")
                            );
