...
public class RTS_ParseInput extends RTS_StatefulClasses {
    ...
    public static class classidentifiers {
        ...
        public String broadsideSelectionKeydown = RTS_StatefulClasses.getUniqueIdentifier();
    ...
    public RTS_ParseInput(HashMap<String, Object> state) {
        ...
        HashMap<String, Object> init = new HashMap<String, Object>() {{
            ...
            put(RTS_ParseInput.stNames.broadsideSelectionKeydown, false);
        }};
    ...
    private void modifierNegativeCheck () {
        if (!(boolean)this.getState(RTS_ParseInput.stNames.isAltDown)) {
            ...
            this.setState(RTS_TaskManager.stNames.totalTranslation, null);
            this.setState(RTS_TaskManager.stNames.totalRotation, null);
            this.setState(RTS_TaskManager.stNames.totalRotationHold, null);
        }
        if (!(boolean)this.getState(RTS_ParseInput.stNames.isCtrlDown)) {
            this.setState(RTS_ParseInput.stNames.leftClickStoreSec, null);
            if (this.getState(RTS_TaskManager.stNames.totalRotation) != null) {
                if (this.getState(RTS_TaskManager.stNames.totalRotationHold) == null) {
                    this.setState(
                            RTS_TaskManager.stNames.totalRotationHold,
                            this.getState(RTS_TaskManager.stNames.totalRotation)
                    );
                }
                else
                    this.setState(
                            RTS_TaskManager.stNames.totalRotationHold,
                            (float)this.getState(RTS_TaskManager.stNames.totalRotation)
