...
public class RTS_Pathing extends RTS_StatefulClasses {
    ...
    private boolean checkAdjustedStatus(ShipAPI ship) {
        HashMap<String, Vector2f> adjustedShips = (HashMap<String, Vector2f>)this.getState(
    ...
    private boolean checkStopStatus(ShipAPI ship) {
        ArrayList<String> stoppedShips =  (ArrayList<String>)this.getState(
                RTS_CollisionManager.stNames.stoppedShips,
                true
        );
