...
public class RTS_Pathing extends RTS_StatefulClasses {
    ...
    public RTS_Pathing(Object state) {
        ...
        init.put("searchAreaForN", 10000f);
        init.put("searchCoolDown", 0.1f);
        init.put("castDistance", 1000f);
        init.put("castWidthDelta", 2f);
        init.put("isStopped", null);
        init.put("targetEnemy", null);;
    ...
    private float findCollisionsNoReport(ShipAPI ship, Vector2f coOrd) {
        ArrayList<ShipAPI> neighbours = ((RTS_ShipLocAPI)this.getState("ShipLocAPI", true)).
                findAlliedShipNeighbours(ship,(float)this.getState("searchAreaForN"), false);
