...
public class RTS_Context {
     ...
     */
    public float getTimePassed() { return((float)((HashMap<String, Object>)this.state.get("amount")).get("start")); }
    /**
     * @return float, amount of in game time that has passed. This timer will stop ticking when the game is paused.
     */
    public float getTimePassedIngame() { return((float)((HashMap<String, Object>)this.state.get("amount")).get("elapsedPlay")); }
    /**
     * @return ArrayList<ShipAPi></ShipAPi>, A list of enemy ships. Still in development.
     */
    public RTS_ShipLocAPI getNeighboursFast() { return((RTS_ShipLocAPI)this.state.get("ShipLocAPI")); }
    /**
     * @return RTSEventManager, Add event requires RTS_Event. Evaluates a task and executes it ounce all computation is done.
     */
    public RTS_EventManager getEventManager() { return ((RTS_EventManager)((HashMap<String, Object>)this.state).get("eventManager")); }
    /**
