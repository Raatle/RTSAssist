...
**********************************
  Still in DEVELOPMENT for 0.1.1
**********************************

* Phase ships
* Mod compatibility
* Switching between standard and traditional playstyle

Phase ships, while phased, dont seem to obey at least some SHIP COMMANDS and therefore a
new way must be found for controlling them. Currently, ships that are given assignments
will not phase and ships that are phased will not accept assignments. I am looking to
find a fix asap.
...
compatible, starting with Diable Avionics.

Seemless switching between traditional and RTS style combat is problematic as switching
back to traditional style combat has problems with camera control.
