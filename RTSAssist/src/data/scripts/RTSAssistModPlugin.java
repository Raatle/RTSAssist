    ...
    public void onGameLoad(boolean newGame) {
        ...
        if (Global.getSector() != null) {
            if (Global.getSector().getMemory().get("$RTSASSIST_saveData") == null)
                ...
                if (saveData.get("hotKeys") != null)
                    ((HashMap<?, ?>)saveData.get("hotKeys")).clear();
                if (saveData.get("config") != null)
                    ((HashMap<?, ?>)saveData.get("config")).clear();
                if (saveData.get("blockedSystems") != null)
                    ((HashMap<?, ?>)saveData.get("blockedSystems")).clear();
                saveData.clear();
            }
